                ...
                >
                    <Container>
                        ...
                        <p className="mt-2 text-lg text-gray-600">It is important that you read this privacy policy and any other privacy policy or fair
                            ...
                            and why we are using your data. This privacy policy supplements other notices and privacy
                        ...
                        <p className="mt-2 text-lg text-gray-600">
                            ...
                            including any requests to exercise
                            <i>your legal rights</i>, please contact our DPO by email to <a
                            href="mailto:niels@snapandtrack.app">niels@snappandtrack.app</a>.
                        </p>
                        <p className="mt-2 text-lg text-gray-600">
                            You have the right to make a complaint at any time to the personal data regulator in your
                            country . We would, however,
                            appreciate the chance to deal with your concerns before you approach your regulator so
                            please contact us in the first
                            instance.
                        </p>
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                        ...
                        <p className="mt-2 text-lg text-gray-600">
                            We keep our privacy policy under regular review. This version is dated 1 October 2023. Historic versions can be obtained by contacting our DPO.
                        </p>
                        <p className="mt-2 text-lg text-gray-600">
                        ...
                        <p className="mt-2 text-lg text-gray-600">
                            Our website and app may include links to third-party websites, plug-ins and applications.
                            Clicking on those links or
                            enabling those connections may allow third parties to collect or share data about you. We do
                            not control these third-party websites and we are not responsible for their privacy statements.
                        </p>
                        ...
                        <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                            ...
                            <li><strong>Technical Data</strong> includes internet protocol (IP) address, your login
                                ...
                                zone setting and geo-location, browser plug-in types and versions, operating system and
                                platform, and
                                other technology on the devices you use to access this app.
                            </li>
                            <li><strong>Profile Data</strong> includes your username and password, your interests, your
                                ...
                                sporting news articles, your history of using our app and any other users that you have
                                added as friends
                                on the app.
                            </li>
                            <li><strong>Usage Data</strong> includes information about how you use our app, website,
                        ...
                        <p className="mt-2 text-lg text-gray-600">
                            ...
                            Data could be derived from your personal data but is not considered personal data in law as
                            this data will <strong>not</strong> directly
                            or indirectly reveal your identity. For example, we may aggregate your Usage Data to
                            calculate the percentage of users
                            accessing a specific website or app feature. However, if we combine or connect Aggregated
                            Data with your personal
                            data so that it can directly or indirectly identify you, we treat the combined data as
                            personal data, which will be used
                            in accordance with this privacy policy.
                        </p>
                        <p className="mt-2 text-lg text-gray-600">
                            We do not collect any <strong>Special Categories of Personal Data</strong> about you (this
                            ...
                            about your health, and genetic and biometric data). We do not collect any information about
                        ...
                        <p className="mt-2 text-lg text-gray-600">Where we need to collect personal data by law, or under the terms of a contract we have with
                            you, and you fail to
                            provide that data when requested, we may not be able to perform the contract we have or are
                            trying to enter into
                            with you (for example, to provide you with goods or services). In this case, we may have to
                            cancel a product or service
                            you have with us, but we will notify you if this is the case at the time.</p>

                        <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 uppercase mt-5">
                            3. How is your personal data collected?
                        </h2>
                        <p className="mt-2 text-lg text-gray-600">We use different methods to collect data from and about you, including through:</p>

                        <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                            <li><strong>Direct interactions.</strong> You may give us your Identity, Contact and Profile
                                when you fill in forms on our
                                website or app or when you correspond with us by post, phone, email or otherwise. We
                                will not require
                                you to give us any financial data. Personal data may be collected when you:
                                <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                                    <li>use our mobile app;</li>
                                    <li>create an account on our website or app;</li>
                                    <li>subscribe to our service or publications;</li>
                                    <li>request marketing to be sent to you;</li>
                                    <li>enter a challenge, promotion or survey; or</li>
                                    <li>give us feedback or contact us.</li>
                                </ul>
                            </li>
                            <li><strong>Automated technologies or interactions.</strong> When you interact with our
                                website and our app, we will
                                automatically collect Technical Data about your equipment, browsing actions and
                                patterns. We collect this
                                personal data by using cookies, server logs and other similar technologies. We may also
                                receive Technical
                                Data about you if you visit other websites that employ our cookies. Please see our
                                cookie policy for further
                                details.
                            </li>
                            <li><strong>Third parties or publicly available sources.</strong> We will receive personal
                                data about you from various third
                                parties and public sources as set out below<br /> Technical Data from the following parties:
                                <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                                    <li>analytics providers such as Google;</li>
                                    <li>advertising networks such as Google and other search engine providers and
                                        social media platforms; and
                                    </li>
                                    <li>search information providers such as Google</li>
                                    <li>hosting service providers (including for our back-ups and anti-virus), such
                                        as Amazon Webservices based in the EEA (European Economic Area).
                                    </li>
                                </ul>
                            </li>
                        ...
                        <p className="mt-2 text-lg text-gray-600">We have set out below in a table format a description of how we plan to use your personal
                            data and which legal bases
                            we rely on to do so. We have also identified what our legitimate interests are where
                            appropriate.</p>

                        <p className="mt-2 text-lg text-gray-600">
                            Note that we may process your personal data for more than one lawful ground, depending on
                            the specific purpose for
                            which we are using your data. Please contact us if you need details about the specific legal
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="p-2 border border-slate-700">
                                        ...
                                        study how customers play our games)<br/>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            ...
                            <p className="mt-2 text-lg text-gray-600">We strive to provide you with choices regarding certain personal data uses, particularly
                                around marketing and advertising. We have established the following personal data
                                control mechanisms:</p>
                            <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                                <li><strong>Promotional offers from us:</strong> We may use your Identity, Contact,
                                    Technical, Usage and Profile Data to form
                                    a view on what we think you may want or need, or what may be of interest to you.
                                    This is how we decide
                                    which products, services, new games and offers may be relevant for you (we call this
                                    marketing).
                                </li>
                                <li><strong>Not opting out:</strong> You will receive marketing communications from us
                                    if you have requested information
                                    from us or entered a contest on our app, and you have not opted out of receiving
                                    that marketing.
                                </li>
                                <li><strong>Third-party marketing:</strong> We will get your express opt-in consent
                                    before we share your personal data with
                                    any third party for marketing purposes.
                                </li>
                                <li><strong>Opting out:</strong> You can ask us or third parties to stop sending you
                                    marketing messages at any time by emailing
                                    us or by following the opt-out links on any marketing message sent to you or by
                                    contacting us at any time.
                                    Where you opt out of receiving our marketing messages, this will not apply to
                                    personal data provided to
                                    us as a result of you entering a contest on the app, providing details of your
                        ...
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            ...
                            <p className="mt-2 text-lg text-gray-600">
                                ...
                                functionality and operate our app or
                                website.
                            </p>
                            <p className="mt-2 text-lg text-gray-600">
                                You can set your browser to refuse all or some browser cookies, or to alert you when
                                websites set or access cookies.
                                If you disable or refuse cookies, please note that some parts of this website may become
                                inaccessible or malfunction.
                        ...
                        <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 uppercase mt-5">
                            ...
                            <p className="mt-2 text-lg text-gray-600">
                                ...
                                in the table <i>Purposes for
                                which we will use your personal data</i> above.
                            </p>
                            <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                                <li>Internal Third Parties as set out in the <i>Glossary</i>.</li>
                                <li>External Third Parties as set out in the <i>Glossary</i>.</li>
                                <li>Third parties to whom we may choose to sell, transfer or merge parts of our business
                                    ...
                                    change happens to our
                                    business, then the new owners may use your personal data in the same way as set out
                                    in this privacy
                                    policy.
                                </li>
                            </ul>
                            <p className="mt-2 text-lg text-gray-600">We require all third parties to respect the security of your personal data and treat it
                                according to the law. We do not
                                allow our third-party service providers to use your personal data for their own purposes
                                and only permit them to
                        ...
                        <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 uppercase mt-5">
                            ...
                            <p className="mt-2 text-lg text-gray-600">Our external third-party service providers are primarily based in the EU.</p>
                            <p className="mt-2 text-lg text-gray-600">Whenever we transfer your personal data to any third-party provider we assure that at
                                least one of the following safeguards is implemented: </p>
                            <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                                <li>The third-party service provider is based in the EU and adheres to GDPR.</li>
                                <li>The third-party service provider is based outside the EU, but has a data processing
                                    agreement that adheres to GDPR and keeps the data inside EU.
                                </li>
                                <li>In the case of the UK, we will rely on the EU-UK agreements on personal data
                                    processing.
                                </li>
                            </ul>
                        <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 uppercase mt-5">
                            ...
                            <p className="mt-2 text-lg text-gray-600">We have put in place appropriate security measures to prevent your personal data from
                                being accidentally lost, used
                                or accessed in an unauthorised way, altered or disclosed. In addition, we limit access
                                to your personal data to those
                                employees, agents, contractors and other third parties who have a business need to know.
                                They will only process your
                                personal data on our instructions and they are subject to a duty of
                                confidentiality. </p>
                            <p className="mt-2 text-lg text-gray-600">Access to our personal data databases is restricted and only individuals with validated
                                queries and a business reason
                                may gain access. Neither our developers nor service managers have direct instances to
                                our personal data databases.
                                All actions are logged. Data is not kept at any personal devices, nor can it be copied
                                to a USB stick or remote storage
                                drive.</p>
                            <p className="mt-2 text-lg text-gray-600">We have put in place procedures to deal with any suspected personal data breach and will
                                notify you and any
                        ...
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            ...
                            <p className="mt-2 text-lg text-gray-600">We will only retain your personal data for as long as reasonably necessary to fulfil the
                                purposes we collected it for,
                                including for the purposes of satisfying any legal, regulatory, tax, accounting or
                                reporting requirements. We may retain
                                your personal data for a longer period in the event of a complaint or if we reasonably
                                believe there is a prospect of
                                litigation in respect to our relationship with you.</p>
                            <p className="mt-2 text-lg text-gray-600">
                                ...
                                your personal data, the purposes
                                for which we process your personal data and whether we can achieve those purposes
                                through other means, and the
                                applicable legal, regulatory, tax, accounting or other requirements. We utilise
                                automated database scripts to delete
                                the majority of the personal data that we hold. Typically speaking:
                            </p>
                            <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                                <li>We retain Technical Data for a maximum of one year and Usage Data for an extended
                                    duration;
                                </li>
                            ...
                            <p className="mt-2 text-lg text-gray-600">Details of retention periods for different aspects of your personal data are available in
                                our retention policy which you
                                can request from us by contacting us.</p>

                            <p className="mt-2 text-lg text-gray-600">In some circumstances you can ask us to delete your data: see “Your legal rights” below
                                for further information.</p>
                            <p className="mt-2 text-lg text-gray-600">In some circumstances we will anonymize your personal data (so that it can no longer be
                                associated with you) for
                                research or statistical purposes, in which case we may use this information indefinitely
                                without further notice to you. </p>
                        <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 uppercase mt-5">
                            9. Your legal rights
                        </h2>
                            <p className="mt-2 text-lg text-gray-600">Under certain circumstances, you have rights under data protection laws in relation to
                            ...
                            <p className="mt-2 text-lg text-gray-600">If you wish to exercise any of the rights set out above, please contact us.</p>
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            Usually no fee required
                        </h3>
                            <p className="mt-2 text-lg text-gray-600">You will not have to pay a fee to access your personal data (or to exercise any of the
                                other rights). However, we may
                                charge a reasonable fee if your request is clearly unfounded, repetitive or excessive.
                                Alternatively, we could refuse to
                                comply with your request in these circumstances.</p>
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            What we may need from you
                        </h3>
                            <p className="mt-2 text-lg text-gray-600">We may need to request specific information from you to help us confirm your identity and
                                ensure your right to access
                                your personal data (or to exercise any of your other rights). This is a security measure
                                to ensure that personal data is
                                not disclosed to any person who has no right to receive it. We may also contact you to
                                ask you for further information
                                in relation to your request to speed up our response.</p>
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            Time limit to respond
                        </h3>
                            <p className="mt-2 text-lg text-gray-600">We try to respond to all legitimate requests within one month. Occasionally it could take
                                us longer than a month if
                                your request is particularly complex or you have made a number of requests. In this
                                case, we will notify you and keep
                                you updated.</p>
                        <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 uppercase mt-5">
                            10. Glossary
                        </h2>
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            ...
                            <p className="mt-2 text-lg text-gray-600">
                                <strong>Legitimate Interest</strong> means the interest of our business in conducting
                                and managing our business to enable us to give
                                you the best service/product and the best and most secure experience. We make sure we
                                consider and balance any
                                potential impact on you (both positive and negative) and your rights before we process
                                your personal data for our
                                legitimate interests. We do not use your personal data for activities where our
                                interests are overridden by the impact
                                ...
                                you in respect of specific
                                activities by contacting us.
                            </p>
                            <p className="mt-2 text-lg text-gray-600"><strong>Performance of Contract</strong> means processing your data where it is necessary
                            ...
                            <p className="mt-2 text-lg text-gray-600">
                                ...
                                where it is necessary for compliance with a legal
                                obligation that we are subject to.
                            </p>
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            THIRD PARTIES
                        </h3>
                            <p className="mt-2 text-lg text-gray-600"><strong>External Third Parties</strong></p>
                            <ul className="list-disc mt-2 text-lg text-gray-600 ml-10">
                                <li>Service providers acting as processors based in the EU who provide IT, system
                                    administration services and marketing services.
                                </li>
                                <li>Professional advisers based in the EU or UK acting as processors or joint
                                ...
                                <li>Any subsidiaries or holding companies who need to receive your personal data in
                                    order to allow us to fulfil our obligations under this privacy policy or any
                        ...
                        <h3 className="text-2xl font-extrabold tracking-tight text-gray-900 mt-5">
                            ...
                            <p className="mt-2 text-lg text-gray-600"><strong>Request correction</strong> of the personal data that we hold about you. This
                                enables you to have any incomplete or inaccurate
                            ...
                            <p className="mt-2 text-lg text-gray-600">
                                ...
                                legitimate interest (or those of a third party) and
                                ...
                                your personal data for direct marketing purposes. In some cases, we may demonstrate that
                                we have compelling
                                legitimate grounds to process your information which override your rights and freedoms.
                            </p>
                            <p className="mt-2 text-lg text-gray-600">
                                <strong>Request restriction</strong> of processing of your personal data. This enables
                                you to ask us to suspend the processing of your
                            ...
                            <p className="mt-2 text-lg text-gray-600"><strong>Request the transfer</strong> of your personal data to you or to a third party.
                                ...
                                that this right only applies
                                to automated information which you initially provided consent for us to use or where we
                                used the information to
                                perform a contract with you. </p>
                            <p className="mt-2 text-lg text-gray-600"><strong>Withdraw consent at any time</strong> when we are relying on consent to process
                                your personal data. However, this will not
                                ...
                                this is the case at the time you
