...
const features = [
  {
    ...
    description:
      'Effortlessly capture and analyze your golf practice sessions. Gain valuable insights to improve your game and make every practice count.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: 'Challenge Friends & Compete',
    description:
      'Turn practice into thrilling competitions with friends. Conquer challenging drills and compete on leaderboards for golfing greatness.',
    icon: DeviceNotificationIcon,
    screen: StocksScreen,
  },
  {
    name: 'Enhance Skills Anywhere',
    description:
      'Improve your skills anywhere, from the driving range to your backyard. Snap n\' Track is your trusty companion for game enhancement.',
    ...
    >
      ...
      <div className="relative col-span-6">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <CircleBackground color="#189E4E" className="animate-spin-slower" />
        </div>
